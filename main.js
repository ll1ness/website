(function () {
  ...
  function renderSocials() {
    ...
    SOCIALS.forEach(function (s) {
      ...
      a.target = '_blank';
      a.rel = 'noopener';
      a.style.setProperty('--brand', s.color || '#fff');
      a.style.setProperty('--brand-soft', (s.color || '#fff') + '24');
      var left = el('div', 'social-item-left');
      var ico = el('span', 'social-ico');
      ico.innerHTML = '<svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true"><path d="' + s.path + '"/></svg>';
