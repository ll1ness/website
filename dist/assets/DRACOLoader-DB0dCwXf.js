...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Zs(){return new pn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:os(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $s(){return new pn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:os(),fragmentShader:`
...
`].filter(xi).join(`
`)),a=$r(a),a=oa(a,t),a=ca(a,t),o=$r(o),o=oa(o,t),o=ca(o,t),a=la(a),o=la(o),t.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+f);const v=y+m+a,T=y+f+o,D=sa(i,i.VERTEX_SHADER,v),b=sa(i,i.FRAGMENT_SHADER,T);i.attachShader(_,D),i.attachShader(_,b),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(C){if(r.debug.checkShaderErrors){const z=i.getProgramInfoLog(_).trim(),G=i.getShaderInfoLog(D).trim(),V=i.getShaderInfoLog(b).trim();let Z=!0,H=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(Z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,D,b);else{const $=aa(i,D,"vertex"),k=aa(i,b,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
