...
(function () {
  ...
  var TR = {
    ru: {
      ...
      'widget.bio': 'Создаю веб и десктоп приложения с открытым исходным кодом.',
      ...
      'faq.1.content': 'Начинающий software engineer и web-разработчик. Создаю веб-приложения, десктопные программы и API.',
      'faq.2.title': 'Какие проекты ты делаешь?',
      'faq.2.content': 'Работаю над TechOne UI (дизайн-фреймворк), Spark Studio (IDE на JavaFX/JPHP), разными API и другими открытыми проектами на GitHub.',
      'faq.3.title': 'Как с тобой связаться?',
      'faq.3.content': 'Лучший способ — через этот сайт через поддержку. Также можно написать на GitHub или в Steam (на крайняк).',
      'faq.4.title': 'Очередной Вайбкодер?',
      'faq.4.content': 'Да, но который знает гораздо больше рядовых вайбкодеров и не бездумно копипастит код.',
      'faq.5.title': 'Какие технологии ты знаешь?',
      'faq.5.content': 'React, HTML, JS, TS, CSS. C++, Rust, Ruby, Python.',

      'contacts.eyebrow': 'контакты',
      'contacts.title': 'Связаться со мной.',
      'contacts.sub': 'Быстрее всего отвечаю в поддержке на этом сайте.',
      ...
      'chat.err.busy': 'Сервера перегружены. Подожди немного и попробуй снова.',
    ...
    en: {
      ...
      'faq.1.content': 'An aspiring software engineer and web developer. I create web applications, desktop programs, and APIs.',
      'faq.2.title': 'What projects do you work on?',
      'faq.2.content': 'I work on TechOne UI (a design framework), Spark Studio (an IDE built with JavaFX/JPHP), various APIs, and other open-source projects on GitHub.',
      'faq.3.title': 'How do I contact you?',
      'faq.3.content': 'The best way is via the support section on this site. You can also reach out on GitHub or Steam (as a last resort).',
      'faq.4.title': 'Just another "vibecoder"?',
      'faq.4.content': 'Yes, but one who knows far more than the average vibecoder and doesn’t just mindlessly copy-paste code.',
      ...
      'chat.err.busy': 'Servers is overloaded. Wait a moment and try again.',
